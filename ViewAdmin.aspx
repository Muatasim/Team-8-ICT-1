<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ViewAdmin.aspx.cs" Inherits="Grocery_Demo.ViewAdmin" %>
...
<body>
    <form id="form1" runat="server">
     ...
     <div class="container">
                    <div class="jumbotron" style="height: 380px; width: 1145px;">
                        ...
                        <table style="width: 100%">
                            ...
                            <tr>
                                ...
                                <td>
                                    <h5 style="text-align: center; font-size: 40px; color: #47a447; text-align: left">Mix & Match Branch Administrators</h5>
                                </td>
                                <td>
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="false" HorizontalAlign="Center" HeaderStyle-BackColor="#00a400" HeaderStyle-ForeColor="White" CellPadding="4" Width="932px">
        <Columns>       
         <asp:BoundField DataField="Administrator_Name" HeaderText="Name" />
         <asp:BoundField DataField="Administrator_Phone_No" HeaderText="Phone No" />
         <asp:BoundField DataField="Administrator_Email" HeaderText="Email" />
